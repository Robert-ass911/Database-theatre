...
class UserProfile(QtWidgets.QWidget):
    ...
    def __setting_ui(self) -> None:
        ...
        [line_edit.setEnabled(False) for line_edit in (self.id_line_edit, self.power_level_line_edit, self.login_line_edit, self.password_line_edit, self.confirm_password_line_edit, self.position_line_edit)]
    ...
    def fill_line_edits(self) -> None:
        ...
        self.position_line_edit.setText(self.parent.session.user.position)
