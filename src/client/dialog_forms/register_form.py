...
class RegisterForm(QtWidgets.QDialog):
    ...
    def __init_ui(self) -> None:
        ...
        self.label_power_level = QtWidgets.QLabel()
        ...
        self.line_edit_position = QtWidgets.QLineEdit()
        self.line_edit_power_level = QtWidgets.QLineEdit()
    ...
    def __setting_ui(self) -> None:
        ...
        self.label_v_layout.addWidget(self.label_position)
        ...
        self.line_edit_v_layout.addWidget(self.line_edit_position)
    ...
    def register(self) -> None:
        ...
        self.parent().session.register(power_level=int(self.line_edit_power_level.text()), position=self.line_edit_position.text(), login=self.line_edit_login.text(), password=self.line_edit_password.text()),
